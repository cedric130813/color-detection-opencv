...
- This is another openCV project which I'm testing out to detect colours (converting BGR to HSV - refer to [this](https://stackoverflow.com/questions/17063042/why-do-we-convert-from-rgb-to-hsv)), which in this case is red colour. 
